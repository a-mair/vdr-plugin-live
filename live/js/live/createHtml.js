 ...
 * To be used together with functions in pages/js.ecpp
 */
...
function addHdSdIcon(s, hdsd, toolTip, frameParams) {
  s.a += '<div class=\"recording_sd_hd\"><img class=\"sdhd\" src=\"'
  s.a += getThemedLinkPrefixImg();
  s.a += hdsd
  s.a += '.svg\"'
